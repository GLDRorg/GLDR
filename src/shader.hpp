...
struct Shader{
    Shader(const std::string& source){
        ...
        gl::ShaderSource(static_cast<GLuint>(shaderID), 1, &source_glcstr, NULL);
        gl::CompileShader(static_cast<GLuint>(shaderID));
    }
    ...
    bool didCompile() const{
        ...
        gl::GetShaderiv(static_cast<GLuint>(shaderID), gl::GL_COMPILE_STATUS, &test);
    ...
    std::string getLog() const{
        ...
        gl::GetShaderInfoLog(static_cast<GLuint>(shaderID), logSize, NULL, log.data());
